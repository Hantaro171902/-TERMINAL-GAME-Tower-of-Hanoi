...
namespace HanoiTower {
    namespace Services {
        ...
        void GameService::YouWonText(const string& role) {
            ...
            setTextColor(YELLOW);
            cout << "Celebrating the 80th National Day of the Socialist Republic of Vietnam " << endl << flush;
            resetTextColor();
            ...
            cout << R"(
                ...
                
                BBBDBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB^.BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBD
                BBDBBBDBBDBBDBBDBBDBBDBBDBBDBBDBBBF  JBBDBBDBBDBBDBBDBBDBBDBBDBBDBBDBBBB
                BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBDBE    8BBBBBBBBBBBBBBBBBBBBBBBBBBBBBDBBD
                BBBDBBDBBDBBDBBDBBDBBDBBMPMMPPPPP^    .PPPPPMMMPBBBDBBDBBDBBDBBDBBDBBBBB
                BBDBBBBBBBBDBBBBBDBBBBBBBb,                  jeBBBBBBBBBBBBBBBBBBBBBBBBD
                BBBBBDBBDBBBBBDBBBBBDBBBBBBBm,            .jBBBBBDBBDBBDBBDBBDBBDBBDBBBB
                BBBBBBBBBBBBBBBBBBBBBDBBDBBBBBB          BBBBBBBBBBBBBBBBBBBBBBBBBBBDBBD
                BDBDBBDBBDBDBBDBBDBBBBBBBBBBBBF          JBBBBBDBBDBBDBBDBBDBBDBBDBBBBBB
                BBBBBBBBBBBBBBBBDBBDBBDBBDBBDB    .yb,    BBBBBBBBBBBBBBBBBBBBBBBBBBDBBB
                BBBBDBBDBBDBBDBBBBBBBBBBBBBBB' .jBBBBBBm, jBBDBBDBBDBBDBBDBBDBBDBBDBBBDB
                
